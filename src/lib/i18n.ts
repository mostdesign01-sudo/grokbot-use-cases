...
export const ui = {
  ...
  stars: {
    ...
    hint: {
      zh: "编辑打的质量星，不是 GitHub star 数。",
      en: "Editorial quality stars — not GitHub stargazers.",
    },
  },
  fav: {
    save: { zh: "收藏", en: "Save" },
    saved: { zh: "已收藏", en: "Saved" },
    toggle: { zh: "收藏到我的收藏", en: "Save to favorites" },
    mine: { zh: "我的收藏", en: "My favorites" },
    count: { zh: "已收藏 {n} 条", en: "{n} saved" },
    empty: {
      zh: "还没有收藏。点卡片右上角的 ☆，条目就会存到这里。",
      en: "Nothing saved yet. Tap ☆ on any card and it will show up here.",
    },
    local: {
      zh: "只存在这台浏览器的 localStorage 里。不上传，换设备不同步，清缓存会丢。",
      en: "Stored only in this browser’s localStorage. Nothing is uploaded; it does not sync across devices and clearing site data removes it.",
    },
    clear: { zh: "清空收藏", en: "Clear all" },
    clearConfirm: { zh: "清空这台浏览器里的全部收藏？", en: "Remove every favorite saved in this browser?" },
    title: { zh: "我的收藏 · AI UP LAB", en: "My favorites · AI UP LAB" },
    desc: {
      zh: "你在 AI UP LAB 收藏的 Grok Bot 案例、HTML、Agent UI、模型与 Image 2.5 提示词。只存在本地浏览器。",
      en: "Grok Bot cases, HTML, Agent UI, models, and Image 2.5 prompts you saved on AI UP LAB. Stored locally in this browser.",
    },
    lede: {
      zh: "在任意卡片或详情页点 ☆ 收藏；再点一次取消。这页只读本机 localStorage，不是账号，不上云。",
      en: "Tap ☆ on any card or detail page to save; tap again to remove. This page reads local storage only — no account, no cloud.",
    },
  ...
  home: {
    lede: { zh: "每天更新的 AI 教程与工具", en: "Daily AI tutorials & tools" },
    heroTitle: {
      zh: "每天更新的 AI 教程与拿来就用的工具",
      en: "Fresh AI tutorials and ready-to-use tools, every day",
    },
    heroSub: {
      zh: "给想提升 AI 能力的人：跟着教程学会用 Agent，或直接拿走 Skill、组件和网页范例。每条都附原文链接。",
      en: "For people building their AI skills: learn Agents from a tutorial, or take a Skill, a component, or a web example and use it. Every entry links to the original.",
    },
    libGrok: { zh: "Agent 教程与用法", en: "Agent tutorials & playbooks" },
    libHtml: { zh: "网页范例与小工具", en: "Web examples & tools" },
    libAgent: { zh: "可复制的界面组件", en: "Copy-ready UI components" },
    startTitle: { zh: "新手从这里开始", en: "Start here" },
    startMore: { zh: "更多入门教程 →", en: "More starter tutorials →" },
    filterGrok: { zh: "教程与用法", en: "Tutorials & playbooks" },
    filterHtml: { zh: "网页与工具", en: "Pages & tools" },
    filterAgent: { zh: "界面组件", en: "UI components" },
    ...
    filter: { zh: "按想看的内容筛选", en: "Filter by what you want" },
  ...
  path: {
    ...
    combosTease: {
      zh: "路径是玩法。要具体三件套，看",
      en: "Paths are playbooks. For a concrete kit, see",
    },
  },
  combo: {
    kicker: { zh: "AI UP LAB · 三库交叉组合", en: "AI UP LAB · Combos" },
    indexH1: { zh: "一壳 + 一件 + 一案", en: "One shell + one piece + one case" },
    indexLede: {
      zh: "从 HTML、Agent UI、Grok Bot 各挑一条，编成可上课或进工作室的三件套。不是第四面墙。路径管玩法，组合管具体拣货。",
      en: "One HTML shell, one Agent UI piece, one Grok Bot case — a kit for an all-hands class or a design studio. Not a fourth card wall. Paths are playbooks; Combos are concrete picks.",
    },
    indexTitle: { zh: "三库组合 · AI UP LAB", en: "Combos · AI UP LAB" },
    indexDesc: {
      zh: "AI UP LAB 的三库交叉组合：每条配方各取一条 HTML 壳、一件 Agent UI、一个 Grok Bot 案例。",
      en: "Cross-library combos on AI UP LAB: each recipe picks one HTML shell, one Agent UI piece, and one Grok Bot case.",
    },
    list: { zh: "组合列表", en: "Combo list" },
    kit: { zh: "三件套", en: "The kit" },
    html: { zh: "HTML 壳", en: "HTML shell" },
    agentUi: { zh: "Agent UI 件", en: "Agent UI piece" },
    bot: { zh: "Grok Bot 案", en: "Grok Bot case" },
    otherCombos: { zh: "其他组合", en: "Other combos" },
    useFor: { zh: "用在", en: "Use for" },
  },
  model: {
    kicker: { zh: "AI UP LAB · 最新模型", en: "AI UP LAB · Latest models" },
    indexH1: { zh: "最新前沿模型 + 值得看的社区作品", en: "Latest frontier models + notable community builds" },
    indexLede: {
      zh: "一张卡一个模型：官方模型页与社区 showcase 分开标注，厂商数字一律写成「官方称」。首条 GPT-6 Astra，之后的模型按同一结构追加。不是 Grok Bot 用法，也不是第四面墙。",
      en: "One card per model. Official model page and community showcase are labelled apart; vendor figures stay “vendor claim.” Starts with GPT-6 Astra; later models follow the same shape. Not a Grok Bot playbook, not a fourth card wall.",
    },
    indexTitle: { zh: "最新模型 · AI UP LAB", en: "Models · AI UP LAB" },
    indexDesc: {
      zh: "AI UP LAB 的最新模型看板：前沿模型的官方公告与社区 showcase，首条 GPT-6 Astra。",
      en: "AI UP LAB’s latest-models board: official announcements and community showcases for frontier models, starting with GPT-6 Astra.",
    },
    list: { zh: "模型列表", en: "Model list" },
    official: { zh: "官方模型页", en: "Official model page" },
    showcase: { zh: "社区 showcase", en: "Community showcase" },
    product: { zh: "产品主页", en: "Product home" },
    highlights: { zh: "要点（官方称 / 社区称）", en: "Highlights (vendor / community claims)" },
    sources: { zh: "来源", en: "Sources" },
    otherModels: { zh: "其他模型", en: "Other models" },
    ...
    pathsTease: {
      zh: "看板只记模型与作品源。要把模型编进桌上的活，看",
      en: "The board tracks models and their sources. To put a model to work on a desk, see",
    },
  },
  imagePrompt: {
    kicker: { zh: "AI UP LAB · Image 2.5 提示词", en: "AI UP LAB · Image 2.5 prompts" },
    indexH1: { zh: "GPT-Image-2.5 的提示词画廊与案例", en: "GPT-Image-2.5 prompt galleries and cases" },
    indexLede: {
      zh: "一张卡一个可打开的来源：提示词画廊站、案例合集帖或单条可抄的提示词。原站与作者帖分开标注，作者数字一律写成「作者称」，不写点赞浏览。每日追加。不是模型卡，也不搬运别人的整条提示词库。",
      en: "One card per openable source: a prompt-gallery site, a case roundup post, or a single prompt worth copying. The site and the author’s post are labelled apart; author figures stay “author’s claim,” and no likes or views are recorded. Added to daily. Not model cards, and no wholesale copying of anyone’s prompt library.",
    },
    indexTitle: { zh: "Image 2.5 提示词 · AI UP LAB", en: "Image 2.5 prompts · AI UP LAB" },
    indexDesc: {
      zh: "AI UP LAB 的 Image 2.5 提示词看板：GPT-Image-2.5 / ChatGPT Images 2.5 的提示词画廊、案例合集与可抄的提示词，首条 img.dsxzai.com。",
      en: "AI UP LAB’s Image 2.5 prompts board: prompt galleries, case roundups, and copyable prompts for GPT-Image-2.5 / ChatGPT Images 2.5, starting with img.dsxzai.com.",
    },
    list: { zh: "提示词条目列表", en: "Prompt entry list" },
    model: { zh: "模型", en: "Model" },
    primarySource: { zh: "主来源", en: "Primary source" },
    otherSources: { zh: "其他来源", en: "Other sources" },
    openSource: { zh: "打开原站", en: "Open the source" },
    highlights: { zh: "要点（作者称 / 本库核到）", en: "Highlights (author’s claims / checked here)" },
    sources: { zh: "来源", en: "Sources" },
    otherItems: { zh: "其他条目", en: "Other entries" },
    listed: { zh: "写入看板", en: "Listed here" },
    sourceCount: { zh: "来源数", en: "Sources" },
    relatedModels: { zh: "相关模型卡", en: "Related model cards" },
    relatedModelsHint: {
      zh: "最新模型看板上的相关卡：这条提示词条目所属的模型。",
      en: "Related cards on the Models board: the model this prompt entry belongs to.",
    },
    previewCredit: { zh: "预览出处", en: "Preview credit" },
    modelsTease: {
      zh: "这里只记提示词与案例源。模型本体与官方公告，看",
      en: "This board tracks prompts and case sources only. For the model itself and official announcements, see",
    },
  },
  grok: {
