...
export const ui = {
  ...
  fav: {
    ...
    desc: {
      zh: "你在 AI UP LAB 收藏的 Grok Bot 案例、HTML、Agent UI 与模型。只存在本地浏览器。",
      en: "Grok Bot cases, HTML, Agent UI, and models you saved on AI UP LAB. Stored locally in this browser.",
    },
    lede: {
