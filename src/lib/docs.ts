...
export const docGroups = [
  { id: "product" as const, title: "产品与发布", blurb: "先从官网与发布稿理解 Grok Bot 的定位。" },
  { id: "docs" as const, title: "官方文档", blurb: "xAI 文档站上的 Grok Bot 指南。" },
  { id: "cursor" as const, title: "Cursor 相邻", blurb: "同生态的云端 Agent 自动化，便于对照工程场景。" },
];
